...
function UserItem(props) {
	return (
		...
		<Link to={`/${props.id}/places`}>
			<Card>
				<Card.Img className="user-image" variant="top" src={props.image} alt={props.name} />
				<Card.Body>
					<Card.Text>
						{props.first_name} {props.last_name} {props.places.length} {props.places.length === 1 ? "Place" : "Places"}
					</Card.Text>
				</Card.Body>
			</Card>
		</Link>
